            ...
            <div className='px-24 w-9/12 mt-20 mb-36 space-y-10'>
                <div className='flex items-center'>
                    <div className='text-blue-dark text-left space-y-3'>
                        <p className='text-5xl font-dm font-semibold tracking-tighter'>Have something in common?</p>
                        <div className='w-2/3'>
                        <p className='text-2xl text-blue-default font-dm italic tracking-tight'>I’m all about sharing the stories and inspirations that got me here. Drop me a message below!</p>
                        </div>
                        <div className='py-5'>
                        <a className='bg-blue-dark border-2 border-solid border-blue-dark text-yellow-light hover:bg-yellow-bg hover:text-blue-dark text-xl font-dm font-normal rounded-2xl px-8 py-2' href='https://www.linkedin.com/in/joelle-lintag/' target='_blank'>Let's Chat</a>
                        </div>
                    </div>
                    <Image
                    alt="Yellow Clover"
